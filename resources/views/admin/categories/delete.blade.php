                        ...
                        <div class="alert alert-danger" role="alert">
                            ...
                            <div class="mb-0">
                                <div class="row my-1">
                                    ...
                                    <div class="col-sm-9 pl-3 py-1 border border-secondary rounded">{{ $category->title }}</div>
                                </div>
                                <div class="row my-1">
                                    <div class="col-sm-3 text-right pr-3 py-1">Code</div>
                                    <div class="col-sm-9 pl-3 py-1 border border-secondary rounded">{{ $category->code }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form class="form-horizontal" method="post" action="{{ route($route_name.'.delete', ['id' => $category->id]) }}">
                        @csrf
